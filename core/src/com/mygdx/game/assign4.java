...
public class assign4 extends ApplicationAdapter {
	SpriteBatch batch;
	...
	public void create() {
		...
		// Create two identical sprites slightly offset from each other vertically and horizontally
		...
		// Have the first sprite combine with both the other sprite and the ground.
